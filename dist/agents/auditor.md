...
# Auditor agent doctrine pack

Adversarially locate invariant bypasses, dishonest certainty, and ungoverned authority.

## Assembly

Ceiling `detailed`, declared for the `auditor` pack in `manifest/agents.yaml`. A section annotated above that ceiling is withheld here. Nothing was withheld at this ceiling.
