...
- One inventory test keeps example directories, package names, and workspace
  membership aligned.
- Nineteen tooling tests exercise doctrine linting, decision-record registry
